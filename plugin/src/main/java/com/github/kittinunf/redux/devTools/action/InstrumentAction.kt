...
class SetStateInstrumentAction(override val payload: Payload) : InstrumentAction(type = ActionType.STATE.name) {
...
class JumpToStateInstrumentAction(override val payload: Int) : InstrumentAction(type = ActionType.JUMP_TO_STATE.name) {
...
class InitInstrumentAction(override val payload: String) : InstrumentAction(type = ActionType.INIT.name) {
